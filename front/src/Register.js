...
export default function Register() {
	...
	function checkMatchingPasswords(event) {
		event.preventDefault();
		setPasswordMatch(
			password.current.value === passwordConfirm.current.value ? true : false
		);
	}
					...
					<form onSubmit={event => handleSubmitRegister(event)}>
						...
						<div className="form-group">
							...
							<input
								...
								className={
									'form-control ' + (validUsername ? '' : 'is-invalid')
								}
								id="usernameInput"
						...
						<div className="form-group">
							<label htmlFor="confirmPasswordInputLogin">
								Confirm password
							</label>
							<input
								type="password"
								...
								onChange={checkMatchingPasswords}
								className={
									'form-control ' + (passwordsMatch ? '' : 'is-invalid')
								}
